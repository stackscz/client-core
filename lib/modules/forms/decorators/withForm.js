...
var withForm = function withForm() {
	...
	return (0, _recompose.compose)((0, _recompose.withProps)(function (props) {
		...
		validate: function validate(_ref) {
			...
			return function (values, props) {
				...
				var validateJsonSchemaErrors = wrapAsErrors((0, _validateByJsonSchema2.default)(normalizedValues, finalSchema, finalErrorMessages));
	...
	}), (0, _omitProps2.default)(['errorMessagesPrefix', 'errorMessages', 'userValidate', 'checkErrors']), (0, _reduxForm.reduxForm)({ shouldValidate: function shouldValidate() {
			return true;
		} }));
};
