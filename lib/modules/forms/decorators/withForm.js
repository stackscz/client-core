...
function withForm() {
	...
	var _ref$schema = _ref.schema,
	    ...
	    _ref$enableObjectDefa = _ref.enableObjectDefaults,
	    enableObjectDefaults = _ref$enableObjectDefa === undefined ? true : _ref$enableObjectDefa,
	    config = (0, _objectWithoutProperties3.default)(_ref, ['schema', 'errorMessagesPrefix', 'errorMessages', 'validate', 'initialValues', 'enableObjectDefaults']);
	...
	return function wrapWithForm(WrappedComponent) {
		...
		return (0, _recompose.compose)((0, _reactRedux.connect)(false, function (dispatch) {
			return {
				setExternalErrors: function setExternalErrors(targetForm, errors) {
					dispatch((0, _reduxForm.stopSubmit)(targetForm, errors));
				}
			};
		}), (0, _recompose.branch)((0, _constant3.default)(enableObjectDefaults), (0, _recompose.withProps)(function (_ref2) {
			var initialValues = _ref2.initialValues,
			    schemaFromProps = _ref2.schema;

			var valueSchema = schemaFromProps || schema;
			return {
				initialValues: (0, _assignDefaultsToRequiredObjectProperties2.default)(initialValues, valueSchema)
			};
