...
exports.default = (0, _recompose.compose)((0, _recompose.withState)('refreshInterval', 'setRefreshInterval', null), _withReconnectionTimer2.default, (0, _recompose.withState)('now', 'setNow', function () {
	return new Date();
...
}), (0, _recompose.withPropsOnChange)(['now', 'reconnectionRetryAt'], function (_ref) {
	var now = _ref.now,
	    reconnectionRetryAt = _ref.reconnectionRetryAt;
