...
var mergeDataMutatorSelector = function mergeDataMutatorSelector(state) {
	return (0, _get3.default)(state, 'resources.mergeDataMutator', function (data, link) {
		return data;
	});
};
			...
			switch (_context.prev = _context.next) {
				...
				case 30:
					...
					return (0, _effects.put)((0, _actions2.persistResource)({
						link: link,
						transient: (0, _isUndefined3.default)(link) || (0, _get3.default)(resource, 'transient', true),
				...
				case 40:
					...
					dataToTransfer = mergeDataMutator((0, _stripReadOnlyProperties2.default)(inputData, finalResourceSchema), parentLink || link);
					callResult = void 0;
