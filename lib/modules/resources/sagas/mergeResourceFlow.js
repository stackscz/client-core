...
function mergeResourceTask(_ref) {
	...
	var resourceSchema, collectionResourceSchema, finalResourceSchema, idPropertyName, idValueFormLink, idValueFormData, data, r, selfLink, selfLinkName, resource, dataToReceive, _normalizeResource, resourceNormalizationResult, normalizedEntities, validAtTime, apiDescription, ApiService, mergeDataMutator, dataToTransfer, callResult, receivedSelfLink, _normalizeResource2, receivedResourceNormalizationResult, receivedNormalizedEntities;
		...
		while (1) {
			switch (_context.prev = _context.next) {
				...
				case 57:
					...
					dataToTransfer = mergeDataMutator(collectionLink || selfLink, (0, _stripReadOnlyProperties2.default)(data, finalResourceSchema));
					callResult = void 0;
