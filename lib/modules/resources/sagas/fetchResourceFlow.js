...
var _normalizeResource2 = require('../utils/normalizeResource');

var _normalizeResource3 = _interopRequireDefault(_normalizeResource2);
...
var _findResourceLinksNames = require('../utils/findResourceLinksNames');

var _findResourceLinksNames2 = _interopRequireDefault(_findResourceLinksNames);
...
function fetchResourceTask(action) {
	var _action$payload, link, relations, apiDescription, ResourcesService, resourceSchema, requestedLinks, relationIndex, relationSpec, rel, relationLinkName, resource, linksRels, links, linksRelsEntries, linkIndex, _linksRelsEntries$lin, relName, linkName, _ref, name, params, _normalizeResource, result, entities, time, validAtTime;
	...
	return _regenerator2.default.wrap(function fetchResourceTask$(_context) {
		while (1) {
			switch (_context.prev = _context.next) {
				...
				case 36:
					linksRels = (0, _findResourceLinksNames2.default)(resourceSchema);
					links = {};
					linksRelsEntries = (0, _entries2.default)(linksRels);
					linkIndex = 0;

				case 40:
					if (!(linkIndex < linksRelsEntries.length)) {
						_context.next = 53;
						break;
					}

					_linksRelsEntries$lin = (0, _slicedToArray3.default)(linksRelsEntries[linkIndex], 2), relName = _linksRelsEntries$lin[0], linkName = _linksRelsEntries$lin[1];
				...
				case 44:
					_context.next = 46;
					return (0, _effects.select)((0, _selectors.resolvedLinkSelectorFactory)({
						name: linkName,
						params: resource
					}));
				...
				case 46:
					...
					links[relName] = (0, _hash2.default)({ name: name, params: params });
				...
				case 53:
					_normalizeResource = (0, _normalizeResource3.default)(resource, resourceSchema), result = _normalizeResource.result, entities = _normalizeResource.entities;
					_context.next = 56;
				...
				case 60:
					_context.next = 62;
					return (0, _effects.put)((0, _actions2.receiveResource)({
						link: link,
						links: links,
						content: result
					}));
