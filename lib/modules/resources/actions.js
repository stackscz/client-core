...
function receiveResource(_ref5) {
	...
	return { type: RECEIVE_RESOURCE, payload: { link: link, links: links, content: content } };
}
...
function mergeResource(_ref6) {
	var link = _ref6.link,
	    data = _ref6.data,
	    collectionLink = _ref6.collectionLink;

	return { type: MERGE_RESOURCE, payload: { link: link, data: data, collectionLink: collectionLink } };
}
...
function persistResource(_ref7) {
	var link = _ref7.link,
	    ...
	    collectionLink = _ref7.collectionLink;

	return { type: PERSIST_RESOURCE, payload: { link: link, transient: transient, links: links, content: content, collectionLink: collectionLink } };
}
...
function receivePersistResourceSuccess(_ref8) {
	var link = _ref8.link,
	    ...
	    collectionLink = _ref8.collectionLink,
	    transientLink = _ref8.transientLink,
	    transientContent = _ref8.transientContent;

	return {
		type: RECEIVE_PERSIST_RESOURCE_SUCCESS,
		payload: { link: link, content: content, collectionLink: collectionLink, transientLink: transientLink, transientContent: transientContent }
	};
}
