...
exports.FORGET_RESOURCE = exports.RECEIVE_DELETE_RESOURCE_SUCCESS = exports.RECEIVE_DELETE_RESOURCE_FAILURE = exports.DELETE_RESOURCE = exports.RECEIVE_PERSIST_RESOURCE_FAILURE = exports.RECEIVE_PERSIST_RESOURCE_SUCCESS = exports.PERSIST_RESOURCE = exports.MERGE_RESOURCE = exports.RECEIVE_RESOURCE = exports.RECEIVE_FETCH_RESOURCE_FAILURE = exports.FETCH_RESOURCE = exports.ENSURE_RESOURCE = exports.DEFINE_RESOURCE = undefined;
...
function fetchResource(_ref3) {
	var link = _ref3.link,
	    ...
	    timestamp = _ref3$timestamp === undefined ? (0, _format2.default)(new Date()) : _ref3$timestamp;

	return { type: FETCH_RESOURCE, payload: { link: link, relations: relations, timestamp: timestamp } };
}
...
function receiveFetchResourceFailure(_ref4) {
	var link = _ref4.link,
	    ...
	    timestamp = _ref4$timestamp === undefined ? (0, _format2.default)(new Date()) : _ref4$timestamp;

	return { type: RECEIVE_FETCH_RESOURCE_FAILURE, payload: { link: link, error: error, timestamp: timestamp } };
}
...
function receivePersistResourceFailure(_ref9) {
	var link = _ref9.link,
	    parentLink = _ref9.parentLink,
	    error = _ref9.error;

	return { type: RECEIVE_PERSIST_RESOURCE_FAILURE, payload: { link: link, parentLink: parentLink, error: error } };
}
