...
exports.default = function (_ref) {
	...
	return (0, _recompose.compose)(_recompose.pure, (0, _recompose.branch)(function () {
		return !!linkFactory;
	}, (0, _recompose.withProps)(function (props) {
		return { link: linkFactory(props) };
	}), (0, _recompose.withProps)(function (props) {
		return { link: (0, _get3.default)(props, linkPropName) };
		...
		return function () {
			...
			dispatch((0, _actions.mergeResource)({ link: link || resourceLink, data: data, collectionLink: collectionLink }));
		};
