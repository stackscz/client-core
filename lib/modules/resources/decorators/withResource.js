...
var _withHandlers3 = require('recompose/withHandlers');

var _withHandlers4 = _interopRequireDefault(_withHandlers3);
...
exports.default = function (_ref) {
	...
	return (0, _compose3.default)(_pure3.default, (0, _withProps3.default)(function (props) {
	...
	}), (0, _withHandlers4.default)((_withHandlers2 = {}, (0, _defineProperty3.default)(_withHandlers2, handleEnsureResourceKey, function (_ref3) {
	...
	}), (0, _defineProperty3.default)(_withHandlers2, handleFetchResourceKey, function (_ref4) {
	...
	}), (0, _defineProperty3.default)(_withHandlers2, 'handleDelete' + (0, _upperFirst3.default)(outputPropsPrefix) + 'Resource', function undefined(_ref5) {
	...
	}), (0, _defineProperty3.default)(_withHandlers2, 'handleMerge' + (0, _upperFirst3.default)(outputPropsPrefix) + 'Resource', function undefined() {
	...
	}), (0, _defineProperty3.default)(_withHandlers2, 'handleForget' + (0, _upperFirst3.default)(outputPropsPrefix) + 'Resource', function undefined(_ref9) {
	...
	}), _withHandlers2)), (0, _lifecycle2.default)(autoload ? {
