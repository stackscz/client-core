...
var _denormalizeResource = require('./utils/denormalizeResource');
...
var denormalizedResourceSelectorFactory = exports.denormalizedResourceSelectorFactory = (0, _fastMemoize2.default)(function (link) {
	...
	return (0, _reselect.createSelector)(pathsSelector, definitionsSelector, resourceSelectorFactory(link), _selectors.entityDictionarySelector, function (paths, definitions, resource, entityDictionary) {
		...
		var finalResourceSchema = resourceSchema;
		if ((0, _get3.default)(resourceSchema, 'type') === 'array') {
			var itemSchema = (0, _resolveSubschema2.default)(resourceSchema, 'items');
			var idPropertyName = (0, _getIdPropertyName2.default)(itemSchema);
			if (!idPropertyName) {
				finalResourceSchema = (0, _extends3.default)({}, finalResourceSchema, {
					items: (0, _extends3.default)({}, itemSchema, {
						'x-idPropertyName': _constants.INTERNAL_ID_PROPERTY_NAME
					})
				});
			}
		} else {
			var _idPropertyName = (0, _getIdPropertyName2.default)(resourceSchema);
			if (!_idPropertyName) {
				finalResourceSchema = (0, _extends3.default)({}, finalResourceSchema, {
					'x-idPropertyName': _constants.INTERNAL_ID_PROPERTY_NAME
				});
		...
		var content = (0, _denormalizeResource2.default)(resource.content, finalResourceSchema, entityDictionary, maxLevel);
