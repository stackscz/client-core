...
var removeResourceHandlerSpec = [_tcomb2.default.struct({
	...
	if (resource) {
		...
		if (!(0, _isArray3.default)(idToRemove)) {
			(0, _each3.default)(collectionsLinks, function (parentLink) {
				var collectionResourceId = (0, _hash2.default)(parentLink);
...
exports.default = (0, _createReducer3.default)(_tcomb2.default.struct({
	...
	mergeDataMutator: _tcomb2.default.maybe(_tcomb2.default.Function)
	...
	parentLink: _tcomb2.default.maybe(ResourceLink),
	...
	var _ref2$payload = _ref2.payload,
	    ...
	    parentLink = _ref2$payload.parentLink;
	...
	var _ref3$payload = _ref3.payload,
	    ...
	    parentLink = _ref3$payload.parentLink;
