...
var visitSchema = function visitSchema(schemaAttr, resources, resourceLinkName, schemasBag) {
	if ((0, _isString3.default)(schemaAttr)) {
		return undefined;
	}

	var schema = schemaAttr;
	var allOfSchema = (0, _get3.default)(schema, 'allOf');
	if (allOfSchema && (0, _isArray3.default)(allOfSchema)) {
		var _definitions = (0, _get3.default)(schema, 'definitions', {});
		var mergedSchemas = (0, _reduce3.default)(allOfSchema, function (acc, schemaItem) {
			if ((0, _isString3.default)(schemaItem)) {
				return acc;
			}

			var schemaElement = resolveJsonPointer(schema, (0, _extends5.default)({}, schemaItem, {
			...
			(0, _assign3.default)(acc.properties, (0, _get3.default)(schemaElement, 'properties', {}));

			acc.required = (0, _uniq3.default)((0, _concat3.default)(acc.required, (0, _get3.default)(schemaElement, 'required', [])));
		...
		var schemaCopy = (0, _cloneDeep3.default)(schema);
		(0, _assign3.default)(schemaCopy, mergedSchemas);
	...
	if ((0, _isArray3.default)(valueType)) {
		...
		switch (valueType) {
			case 'array':
				...
				// }
				var arrayItemJSONSchema = resolveJsonPointer(schema, (0, _get3.default)(schema, 'items'));
				if (!arrayItemJSONSchema) {
					return undefined;
				}
				var arrayItemSchema = visitSchema(arrayItemJSONSchema, resources, undefined, schemasBag);
				if (!arrayItemSchema) {
					return undefined;
				}
				var resultingSchema = new _normalizr.schema.Array(arrayItemSchema);
				if (resourceLinkName) {
			...
			case 'object':
				...
				if (modelName) {
					...
					if (resourceLinkName && resourceLinkName !== modelName) {
						// debugger;
						var objectResourceSchema = new _Resource2.default(resourceLinkName, objectSchema, (0, _get3.default)(resources, resourceLinkName));
